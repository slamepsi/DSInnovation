...
namespace DSInnovation
{
	class MainClass
	{
		...
		public static void Main (string[] args)
		{
			...
			Interface.familleListe.Add( new Famille( "Lepretre", "1 rue des jardins de l'église Chéreng", 100, 1 ) );
			Interface.familleListe.Add( new Famille( "Buirette", "Lille", 10, 2 ) );
			Interface.familleListe.Add( new Famille( "Argenson", "Lambersar, rue des noobs", 50, 4 ) );
